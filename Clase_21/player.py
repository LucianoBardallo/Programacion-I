...
class Player:
    def __init__(self,x,y,speed_walk,speed_run,gravity,jump_power,frame_rate_ms,move_rate_ms,jump_height,p_scale=1,interval_time_jump=100) -> None:
        ...
        self.stay_r = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Idle ({0}).png",10,flip=False,scale=p_scale)
        self.stay_l = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Idle ({0}).png",10,flip=True,scale=p_scale)
        self.jump_r = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Jump ({0}).png",10,flip=False,scale=p_scale)
        self.jump_l = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Jump ({0}).png",10,flip=True,scale=p_scale)
        self.walk_r = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Run ({0}).png",8,flip=False,scale=p_scale)
        self.walk_l = Auxiliar.getSurfaceFromSeparateFiles(PATH_IMAGE + "caracters/players/cowgirl/Run ({0}).png",8,flip=True,scale=p_scale)
