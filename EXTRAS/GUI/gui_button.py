...
class Boton(Widget):
    def __init__(self,master,x=0,y=0,w=200,h=50,color_fondo=C_GREEN,color_borde=C_RED,imagen_fondo=None,texto="Button",fuente="Arial",fuente_tamaño=14,fuente_color=C_BLUE,click=None,click_parametro=None):
